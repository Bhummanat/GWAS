---
title: "joining_LGG_data"
author: "Bhummanat"
date: "2024-11-09"
output: html_document
---

This script handles datasets of multiple covariates and joins into one main dataframe.
Refer to covariates_readme.
...
Format in SLURM is:
Rscript joining.R chr#
```{r Capture command-line arguments}
args <- commandArgs(trailingOnly = TRUE)
chromosome <- args[1]
```

Loading the processed SNPs dataset
```{r Wrangling SNPs Dataset}
...
Handling the rest of the covariates dataset
Refer to covariates_readme
```{r Wrangling other covariates datasets}
# Covariates datasets
...
Join and formatting types
```{r Joining all datasets}
...
Write as .rds to save dataframe type
```{r Writing output}
